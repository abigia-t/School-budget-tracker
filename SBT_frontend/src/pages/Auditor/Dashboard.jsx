    ...
    <div className="max-w-5xl mx-auto p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Budgets Reviewed</h2>
          <p className="text-2xl font-bold text-gray-800">{auditData.totalBudgetsReviewed}</p>
        </div>

        {/* Pending Approvals */}
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Pending Approvals</h2>
          <p className="text-2xl font-bold text-red-600">{auditData.pendingApprovals}</p>
        </div>

        {/* Completed Audits */}
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Completed Audits</h2>
          <p className="text-2xl font-bold text-green-600">{auditData.completedAudits}</p>
        </div>
